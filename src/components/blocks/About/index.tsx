...
function About({ headline, body, anchor, callToAction, images }: SectionType) {
  ...
  return <Section className="text-center pt-[74px]" anchor={anchor?.tag}>
    <div className="absolute inset-0 z-0">
      <Picture image={bgImage} alt={''} className="[&>img]:h-full [&>img]:w-full" />
    </div>
    <div className="relative z-10">
      <Picture image={image} quality={100} alt={headline} className="[&>img]:m-auto md:[&>img]:p-0 [&>img]:px-10 brightness-75" />
