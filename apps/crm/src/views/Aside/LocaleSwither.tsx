...
const ICONS: Record<string, (props: React.SVGProps<any>) => React.JSX.Element> = {
  ...
  ru: (props: React.SVGProps<any>) => (
    <svg viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg" fill="currentColor" {...props}>
      <g fillRule="evenodd" strokeWidth="1pt">
...
const CurrentLocale = ({ locale, ...props }: React.SVGProps<any> & { locale: string }) => {
  switch (locale) {
    case 'uk': return <ICONS.uk {...props} />;
    case 'en': return <ICONS.en {...props} />;
    case 'ru': return <ICONS.ru {...props} />;
  }
