...
const ModalContent = ({ onDismiss }: ModalType) => {
  ...
  return <div className="m-auto sm:w-full sm:max-w-sm overflow-hidden px-4 pt-5 pb-4 sm:my-8 sm:p-6 bg-white rounded-lg shadow-xl border dark:border-gray-600 dark:bg-gray-900">
    ...
    <form className="mt-4" action="#">
      ...
      <div className="mt-4 sm:flex sm:items-center sm:-mx-2">
        <button onClick={onDismiss} type="button" className="w-full px-4 py-2 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md sm:w-1/2 sm:mx-2 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800 hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40">
          Cancel
        </button>
